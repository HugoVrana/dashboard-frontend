...
export default function DashboardNavigationMenu() {
  ...
  return (
      <NavigationMenu.Root className="relative w-full rounded-lg">
        ...
        <NavigationMenu.List className="relative flex items-center gap-2 pr-16">
          <NavigationMenu.Item>
        ...
        <NavigationMenu.Portal>
          ...
          >
            <NavigationMenu.Popup
                className={cn(
                    "data-[ending-style]:easing-[ease] relative h-[var(--popup-height)] origin-[var(--transform-origin)] rounded-lg outline outline-1 transition-[opacity,transform,width,height,scale,translate] duration-[var(--duration)] ease-[var(--easing)] data-[ending-style]:scale-90 data-[ending-style]:opacity-0 data-[ending-style]:duration-150 data-[starting-style]:scale-90 data-[starting-style]:opacity-0 w-[var(--popup-width)] xs:w-[var(--popup-width)]",
                    colors.popup
                )}
            >
              <NavigationMenu.Arrow className="flex transition-[left] duration-[var(--duration)] ease-[var(--easing)] data-[side=bottom]:top-[-8px] data-[side=left]:right-[-13px] data-[side=left]:rotate-90 data-[side=right]:left-[-13px] data-[side=right]:-rotate-90 data-[side=top]:bottom-[-8px] data-[side=top]:rotate-180">
                <ArrowSvg arrowFill={colors.arrowFill} arrowBorder={colors.arrowBorder} />
...
function ArrowSvg({
                    ...
                    arrowBorder,
                    ...props
                  }: React.ComponentProps<"svg"> & { arrowFill: string; arrowBorder: string }) {
  return (
