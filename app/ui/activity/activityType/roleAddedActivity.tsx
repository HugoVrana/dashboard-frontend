...
export default function RoleAddedActivity({activity}: {activity: ActivityEvent}) {
    const actorId = activity.actorId as string | undefined;
    const roleName = activity.roleName as string | undefined;

    return (
        <li className="flex items-center gap-3 p-3 rounded-lg bg-amber-500/10 hover:bg-amber-500/20 transition-colors border-l-2 border-amber-500">
