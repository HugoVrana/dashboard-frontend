...
import {getCookie} from "@/app/shared/cookieUtil";
import {GlobeIcon} from "lucide-react";
import {useDebugTranslations} from "@/app/shared/contexts/translations/useDebugTranslations";
import {Select, SelectContent, SelectItem, SelectTrigger} from "@hugovrana/dashboard-frontend-shared";

function LanguageToggle() {
    const [locale, setLocale] = useState("en");
    const t = useDebugTranslations("shared.lang");
